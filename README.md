...
🌐 Live Demo: [https://mri-condyle-net.vercel.app](https://mri-condyle-net.vercel.app/)
...
- Backend API – Connects to Flask API for AI model inference

------------------------------------------------------------------

## 🖼️ Key Features
- Login and Register using an authentication token
- Upload MRI images
- AI predictions and visualization
...
- Replace the URL with the Flask backend address.
4. **Run server**
- npm run dev
- Access in a browser: http://localhost:3000
...
| Name | Task |
|----------------------------|-------------------------|
| **Enrio Hernanda** | Frontend (Next.js) |
| **Anugrah Lan Pambudi** | Backend (Flask API) |
| **Kafah Alfarizi Andeza** | Machine Learning Model |

> This repository only covers the **Frontend** part. The backend and AI model are stored in separate repositories.
